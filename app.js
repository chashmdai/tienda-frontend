/**
 * Frontend CRUD para productos de la tienda de perritos.
 * La URL base es relativa: nginx actúa de reverse proxy hacia el backend
 * en la subred privada. El navegador NUNCA habla con el backend directamente.
 */
...
function renderProductos(productos) {
  ...
  document.querySelectorAll(".btn-eliminar").forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      if (confirm("¿Seguro que deseas eliminar este producto?")) eliminarProducto(id);
    });
  });
}
